...
| 問題生成規則           | `client/src/game/puzzles.ts`      | Stage 1〜3全36問は手設計、残りは決定的生成。`pnpm puzzles:write` |
...
- 序盤36問の手設計導入（Stage 1全12問: AREAなし→AREA導入→ルート読解、Stage 2全12問: ルート読解→AREA連鎖、Stage 3全12問: 幅5列のルート読解→AREA連鎖）
